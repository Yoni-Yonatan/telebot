...
const ADMIN_CHAT_ID    = process.env.ADMIN_CHAT_ID ? parseInt(process.env.ADMIN_CHAT_ID, 10) : 0;  // set ADMIN_CHAT_ID env var
const CHANNEL_USERNAME = process.env.CHANNEL_USERNAME || "";  // set CHANNEL_USERNAME env var
